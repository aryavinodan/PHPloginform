...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="edit-book.php?bookid=<?php echo htmlentities($result->bookid);?>"><button ><i ></i> Edit</button> 
                                          <a href="manage-books.php?del=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Are you sure you want to delete?');"" >  <button ><i class=></i> Delete</button>
                                            </td>
                                        </tr>
 <?php $cnt=$cnt+1;}} ?>                                      
                                    </tbody>
